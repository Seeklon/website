        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid lg:grid-cols-12 gap-12 max-w-6xl mx-auto items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              {/* Newsletter Card (Dark Mode Contrast) */}
              <div className="relative overflow-hidden rounded-2xl bg-[#0F172A] p-8 text-white shadow-xl shadow-blue-900/10 group">
                ...
                <form className="flex gap-2 relative z-10">
                  ...
                  />
                  <button className="bg-primary hover:bg-primary-light text-white p-3 rounded-xl transition-colors shadow-lg shadow-primary/20">
                    <ArrowRight size={20} />
                  </button>
                </form>
              </div>
            ...
            <div className="lg:col-span-7">
              <div className="relative rounded-3xl bg-white/60 backdrop-blur-xl border border-white/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 md:p-10">

                {/* Petit reflet lumineux en haut */}
                ...
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-text-muted ml-1">Nom complet</label>
                      <input type="text" className="w-full px-5 py-4 rounded-xl bg-white/50 border border-transparent focus:bg-white focus:border-primary/30 focus:ring-4 focus:ring-primary/10 outline-none transition-all duration-300 font-medium text-text-main placeholder-slate-400 shadow-sm" placeholder="John Doe" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-text-muted ml-1">Société</label>
                      <input type="text" className="w-full px-5 py-4 rounded-xl bg-white/50 border border-transparent focus:bg-white focus:border-primary/30 focus:ring-4 focus:ring-primary/10 outline-none transition-all duration-300 font-medium text-text-main placeholder-slate-400 shadow-sm" placeholder="Votre entreprise" />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-text-muted ml-1">Email professionnel</label>
                    <input type="email" className="w-full px-5 py-4 rounded-xl bg-white/50 border border-transparent focus:bg-white focus:border-primary/30 focus:ring-4 focus:ring-primary/10 outline-none transition-all duration-300 font-medium text-text-main placeholder-slate-400 shadow-sm" placeholder="john@company.com" />
                  </div>

                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-text-muted ml-1">Message</label>
                    <textarea rows={5} className="w-full px-5 py-4 rounded-xl bg-white/50 border border-transparent focus:bg-white focus:border-primary/30 focus:ring-4 focus:ring-primary/10 outline-none transition-all duration-300 font-medium text-text-main placeholder-slate-400 shadow-sm resize-none" placeholder="Dites-nous tout..."></textarea>
                  </div>
