                ...
                <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:gap-6">
                    <div className="text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-start">
                            <Link
                                href="/contact"
                                className="w-full rounded-full bg-primary px-8 py-3 text-center text-lg font-medium text-white shadow-lg shadow-primary/20 transition-all hover:bg-primary-dark focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/30 sm:w-auto"
                            >
                                {t('tryProduct')}
                            </Link>
                            <Link
                                href="/product"
                                className="w-full rounded-full border border-primary/20 bg-white/30 px-8 py-3 text-center text-lg font-medium text-primary backdrop-blur-sm transition-all hover:bg-primary/5 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/20 sm:w-auto"
                            >
                                {t('howItWorks')}
                            </Link>
                        </div>
